...
class Aliyun{
    ...
    private $config = array(
        'accessKeyId'     => 'LrrnWwMV4W5c8vn1', //ak
        'accessKeySecret'      => 'lr84aa5YK5fKGuSaYPPwC0162X3i6c', //sk
        'bucket'         => 'wanka-file', //空间名称
    );
    ...
    public function save(&$file,$replace=true) {
        ...
        $ext = $file['ext'];
        $mimeType = Mime_Types::get_mimetype ( $ext );
        ...
        $url = 'http://'.'wanka-file.oss-cn-beijing.aliyuncs.com/'.$file['name'];
        $file['url'] = $url;
